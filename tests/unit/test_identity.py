...
BICEP_FILE = FIXTURES_DIR / 'test-identity.bicep'
PARAMS_FILE = FIXTURES_DIR / 'params-identity.json'


class TestIdentityModule:
    """Test suite for identity module."""

    def test_bicep_compiles(self):
        """Test that the identity test wrapper compiles successfully."""
