...
BICEP_FILE = FIXTURES_DIR / 'test-logic.bicep'
PARAMS_FILE = FIXTURES_DIR / 'params-logic.json'
TEST_RG = 'test-rg'


class TestLogicModule:
    """Test suite for logic module."""

    def test_bicep_compiles(self):
        """Test that the logic test wrapper compiles successfully."""
