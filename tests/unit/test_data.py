"""Unit tests for data module (PostgreSQL)."""
import pytest
...
BICEP_FILE = FIXTURES_DIR / 'test-data.bicep'
PARAMS_FILE = FIXTURES_DIR / 'params-data.json'
TEST_RG = 'test-rg'
...
class TestDataModule:
    ...
    def test_bicep_compiles(self):
        """Test that the data test wrapper compiles successfully."""
